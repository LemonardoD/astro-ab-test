/* eslint-disable */
// Generated by Wrangler by running `wrangler types --path=./functions/types.d.ts` (hash: 4e9d8a360b35cab1bd35fe038ca0e871)
// Runtime types generated with workerd@1.20250617.0 2024-09-23 nodejs_compat
declare namespace Cloudflare {
  interface Env {
    VITE_BASE_API_URL: 'https://api.onedollarstats.com' | 'https://test-api.onedollarstats.com';
    VITE_TRACKER_SRC:
      | 'https://assets.onedollarstats.com/stonks.js'
      | 'https://assets.onedollarstats.com/stonks-dev.js';
    VITE_GITHUB_ID: 'Ov23liZeFDm9KlEDPUIP' | 'Ov23lidcYnNlGTN9dhWB';
    VITE_STAGE: 'production' | 'development';
  }
}
